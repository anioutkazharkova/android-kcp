...
class PluginComponentRegistrar() : CompilerPluginRegistrar() {
    ...
    override fun ExtensionStorage.registerExtensions(configuration: CompilerConfiguration) {
       ...
       SyntheticResolveExtension.registerExtension(SyntethicExtension())
        IrGenerationExtension.registerExtension(ComposableGenerationExtenstion(messageCollector = messageCollector))
        IrGenerationExtension.registerExtension(AndroidGenerationExtenstion(messageCollector = messageCollector))
